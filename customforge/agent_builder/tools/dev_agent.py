...
MAX_FIX_ATTEMPTS = 5
MODEL_PLANNER    = "auto"  # Ollama-first, Gemini backup — see llm_client.py
MODEL_WRITER     = "auto"
...
def _get_model(model_name: str):
    # Routed through tools.llm_client so this also works with a free local
    # Ollama model (pass model_name="ollama:llama3.2") and auto-falls back
    # to Ollama if Gemini's quota is exceeded.
