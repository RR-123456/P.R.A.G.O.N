...
GEMINI_MODEL       = "auto"  # Ollama-first, Gemini backup — see llm_client.py
...
def _get_gemini(model: str = GEMINI_MODEL):
    ...
    # Ollama model (pass model="ollama:llama3.2") and auto-falls back to
    # Ollama if Gemini's quota is exceeded.
