...
def get_base_dir() -> Path:
    ...
    # This file lives at project/features/agentic_feature/agent/planner.py,
    # so go up four levels to reach the project root (same root
    # pragon_main.py and pragon_agent.py resolve to).
...
ABSOLUTE RULES:
- NEVER use generated_code or write Python scripts unless no other tool fits.
- NEVER reference previous step results in parameters. Every step is independent.
- Use web_search for ANY information retrieval, research, or current data.
- Use file_controller to save content to disk.
- Use cmd_control to open files or run system commands.
- Use pragon_fileforger for building a whole multi-file project from a description.
- Use code_helper for a single file: write / edit / run / explain / build / optimize.
...
web_search
  ...
  mode: "search" | "news" | "research" | "price" | "compare" (optional, default: search)
...
cmd_control
  task: string (required) — natural language description of what to open or run
  visible: boolean (optional)

pragon_fileforger
  description: string (required) — what the whole project should do
...
Goal: "build me a small snake game in python"
Steps:

pragon_fileforger | description: "A playable Snake game with a score counter", language: python

Goal: "What is the price of Bitcoin"
Steps:

web_search | query: "Bitcoin price today USD", mode: "price"
