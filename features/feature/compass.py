...
def _detect_intent(description: str, file_path: str, code: str) -> str:
    ...
    screen_kw = ["screen", "on the screen", "this error", "why am i getting",
                 "why is this failing", "what's wrong", "what's incorrect", "screenshot", "the image"]
    if any(k in desc for k in screen_kw):
        return "screen_debug"

    optimize_kw = ["optimize", "refactor", "clean up", "improve", "tidy up",
                   "make it better", "speed up", "faster"]
    ...
    explain_kw = ["explain", "what does", "describe", "analyze", "what is it doing"]
